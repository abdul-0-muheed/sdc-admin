...
const navData = {
  ...
  bottomLinks: [
    ...
    },
    {
      ...
      url: '#',
      children: [
        { id: 'content-banners', label: 'Admissions Banner', url: '/admin/content/banners' },
        { id: 'content-gallery', label: 'Media Gallery', url: '/admin/content/gallery' },
        ...
        { id: 'content-notices', label: 'Important Notices', url: '/admin/content/notices' }
      ]
    },
    {
      id: 'academics',
    ...
    },
    {
      ...
      url: '#',
      children: [
        { id: 'students-admissions', label: 'Applications', url: '/admin/students/admissions' },
        { id: 'students-alumni', label: 'Alumni', url: '/admin/students/alumni' },
        { id: 'students-achievements', label: 'Achievers', url: '/admin/students/achievements' }
      ]
    },
  ],
};
